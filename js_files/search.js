...
//     const searchQuery = document.getElementById('search-input').value.toLowerCase(); // Get the search input value and convert to lowercase
...
//         // Iterate through the products and filter by search query
...
//                 product.name.toLowerCase().includes(searchQuery) // Check if the product name includes the search query
//               ),
//             ];
//           }
//         });
  
//         // Call a function to display the filtered products (you can reuse the existing code for displaying products)
...
//     main_div.innerHTML = ''; // Clear any previously displayed products
...
// // Function to handle search for both large and small search bars
// function handleSearch(event) {
//     event.preventDefault(); // Prevent default form submission

//     // Get search input value from both search bars
...
//             // Iterate through product categories and filter by search query
//             const availableCategories = ['women', 'men', 'kids', 'baby'];
//             availableCategories.forEach(category => {
//                 if (products[0].products[category]) {
//                     filteredProducts = [
